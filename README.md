...
Missing thumbnails are generated by a separate scheduled job for both image and video exports. Video thumbnails are captured from the configured percentage of
the video (30% by default), extracted with JavaCV's bundled FFmpeg runtime, and stored as JPEG thumbnails using the same database relationship and path
convention as image thumbnails:
...
vempain:
    generate-missing-thumbnails:
        ...
        thumb-image-quality: 0.7
        video-capture-percentage: 0.3
```
